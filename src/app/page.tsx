    ...
    <>
      ...
      <section id="cities" className="min-h-screen py-24 px-4 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-2xl md:text-3xl font-serif font-light text-ink tracking-wide">
            城市的收纳切面
          </h2>
          <div className="flex items-center justify-center gap-3 mt-4">
            <span className="block w-8 h-px bg-film opacity-30" />
            <span className="w-1.5 h-1.5 rounded-full bg-film opacity-40" />
            <span className="block w-8 h-px bg-film opacity-30" />
          </div>
          <p className="mt-3 text-sm text-ink-muted tracking-widest">
            每一座城市，都是一个独立的故事
          </p>
        </div>
